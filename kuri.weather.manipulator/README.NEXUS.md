[center][size=5]Weather Manipulator[/size][/center]

[b]A BepInEx 5.4.x (x64) mod for Moonlight Peaks to control and override the current weather conditions.[/b]

[line]

[size=4][color=#6F51B1][b]Features[/b][/color][/size]
[list]
[*][b]Weather Override:[/b] Manually set the weather to your preferred type.[/*]
[*][b]Lock Weather:[/b] Optionally lock the current weather to prevent the game from changing it automatically.[/*]
[*][b]Configurable:[/b] Fine-tune the weather settings in-game using the BepInEx Configuration Manager.[/*]
[/list]
...
[list]
[*][b]Enable Weather Override:[/b] Enable or disable the weather override. Default: False.[/*]
[*][b]Lock Weather (Always):[/b] If active, the game can no longer change the weather on its own.[/*]
[*][b]Selected Weather:[/b] The weather to enforce. Default: Clear_Spring.[/*]
[/list]
