[center][size=5]AutoWin[/size][/center]

[b]A BepInEx 5.4.x (x64) mod for Moonlight Peaks to automatically win the Nokturna mini-game.[/b]

[line]

[size=4][color=#6F51B1][b]Features[/b][/color][/size]
[list]
[*][b]Auto Win:[/b] Automatically completes and wins the Nokturna mini-game without any player input.[/*]
[*][b]Configurable:[/b] Enable or disable the auto-win feature in-game using the BepInEx Configuration Manager.[/*]
[/list]
