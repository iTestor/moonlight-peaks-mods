[center][size=5]BiggerStacks[/size][/center]

[b]A BepInEx 5.4.x (x64) mod for Moonlight Peaks to increase stack sizes for items.[/b]

[line]

[size=4][color=#261546][b]Features[/b][/color][/size]
[list]
[*][b]Custom Stack Sizes:[/b] Adjust the maximum stack size for various items to optimize your inventory management.[/*]
[*][b]Configurable:[/b] Easily customize values in-game using the BepInEx Configuration Manager.[/*]
[/list]

[size=4][color=#261546][b]Requirements[/b][/color][/size]
[list]
...
[size=4][color=#261546][b]Installation[/b][/color][/size]
[list=1]
...
[size=4][color=#261546][b]Configuration[/b][/color][/size]
