[center][size=5]CritterPlus[/size][/center]

[b]Take full control over critter spawn rates, skip catching animations, and track live local spawns.[/b]

[line]

[size=4][color=#6F51B1][b]Features[/b][/color][/size]
[list]
[*][b]Spawn Rate Customization:[/b] Adjust the spawning frequency of various critter species.[/*]
[*][b]Skip Animation:[/b] Optional setting to skip the 'present' animation for faster catch.[/*]
[*][b]Live GUI:[/b] The mod provides a live GUI that displays all critters present in the current area, showing their current counts and maximum limits: [i]Name (Current/Max)[/i].[/*]
...
[*][b]RespawnIntervalMinutes:[/b] Respawn interval in minutes, applies to ALL critters with an active override. (lower = spawns more often)[/*]
[*][b]SkipPresentItemAnimation:[/b] If enabled, the game will skip the 'present' animation.[/*]
[/list]

[color=#6F51B1][b]Available Settings per Critter:[/b][/color]
[list]
...
[*][b]MaxLimit:[/b] Set the maximum limit for a critter (0, 1, 2...).[/*]
[/list]
