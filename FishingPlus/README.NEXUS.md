...
[b]⚠️ IMPORTANT NOTE ON INITIAL CONFIGURATION:[/b]
...
[*]From that moment on, you will have access to the real default values in the F1 menu (and at every future game start) and can adjust them as you like using the sliders![/*]
[/list]
