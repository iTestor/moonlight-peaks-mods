[center][size=5]FlexibleDonation[/size][/center]

[b]A BepInEx 5.4.x (x64) mod for Moonlight Peaks that allows for flexible donation options.[/b]

[line]

[size=4][color=#6F51B1][b]Features[/b][/color][/size]
[list]
[*][b]Flexible Donations:[/b] Customize donation amounts and options.[/*]
[*][b]Configurable:[/b] Enable or disable the mod in-game using the BepInEx Configuration Manager.[/*]
[/list]
...
[list]
[*][b]Enabled:[/b] Enable or disable the mod. Default: True.[/*]
[/list]
